...
def plot_single_sample_initialization_comparison():
    ...
    ax1_main.plot(time_points, true_reflectance, label="ground truth", color="black", linewidth=2)
    ...
    # --- Plotting Thickness ---
    ax2_main.plot(time_points, true_thickness, label="ground truth", color="black", linewidth=2)
    ...
    ax3_main.plot(time_points, true_growth_rate, label="ground truth", color="black", linewidth=2)
