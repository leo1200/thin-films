...
from analyze_single_example import optimize_single_example
...
def test_noise_robustness():
    ...
    (
        ...
        true_thicknessA,
        true_growth_rateA,
        predicted_reflectanceA,
        predicted_thicknessA,
        predicted_growth_rateA,
        initialized_thicknessA,
        initialized_reflectanceA,
        initialized_growth_rateA,
        initialized_time_pointsA,
        snr_dbA
    ...
    (
        ...
        true_thicknessB,
        true_growth_rateB,
        predicted_reflectanceB,
        predicted_thicknessB,
        predicted_growth_rateB,
        initialized_thicknessB,
        initialized_reflectanceB,
        initialized_growth_rateB,
        initialized_time_pointsB,
        snr_dbB
    ) = optimize_single_example(
        model = ONE_LAYER_MODEL,
        plotting = False,
    ...
    (
        ...
        true_thicknessC,
        true_growth_rateC,
        predicted_reflectanceC,
        predicted_thicknessC,
        predicted_growth_rateC,
        initialized_thicknessC,
        initialized_reflectanceC,
        initialized_growth_rateC,
        initialized_time_pointsC,
        snr_dbC
    ) = optimize_single_example(
        model = ONE_LAYER_MODEL,
        plotting = False,
    ...
    jnp.savez(
        "noise_test_data/noisy_example.npz",
        true_reflectanceA = true_reflectanceA,
        true_thicknessA = true_thicknessA,
        true_growth_rateA = true_growth_rateA,
        predicted_reflectanceA = predicted_reflectanceA,
        predicted_thicknessA = predicted_thicknessA,
        predicted_growth_rateA = predicted_growth_rateA,
        initialized_thicknessA = initialized_thicknessA,
        initialized_reflectanceA = initialized_reflectanceA,
        initialized_growth_rateA = initialized_growth_rateA,
        initialized_time_pointsA = initialized_time_pointsA,
        snr_dbA = snr_dbA,

        true_reflectanceB = true_reflectanceB,
        true_thicknessB = true_thicknessB,
        true_growth_rateB = true_growth_rateB,
        predicted_reflectanceB = predicted_reflectanceB,
        predicted_thicknessB = predicted_thicknessB,
        predicted_growth_rateB = predicted_growth_rateB,
        initialized_thicknessB = initialized_thicknessB,
        initialized_reflectanceB = initialized_reflectanceB,
        initialized_growth_rateB = initialized_growth_rateB,
        initialized_time_pointsB = initialized_time_pointsB,
        snr_dbB = snr_dbB,

        true_reflectanceC = true_reflectanceC,
        true_thicknessC = true_thicknessC,
        true_growth_rateC = true_growth_rateC,
        predicted_reflectanceC = predicted_reflectanceC,
        predicted_thicknessC = predicted_thicknessC,
        predicted_growth_rateC = predicted_growth_rateC,
        initialized_thicknessC = initialized_thicknessC,
        initialized_reflectanceC = initialized_reflectanceC,
        initialized_growth_rateC = initialized_growth_rateC,
        initialized_time_pointsC = initialized_time_pointsC,
        snr_dbC = snr_dbC
    )
    ...
    data = jnp.load("noise_test_data/noisy_example.npz")
    ...
    plt.savefig("figures/noise_robustness_test.svg")
