...
def one_layer_no_internal_reflections(
    ...
    delta = 2 * n1 * jnp.pi * layer_params.thicknesses * jnp.sqrt(n1 ** 2 - n0 ** 2 * jnp.sin(setup_params.polar_angle) ** 2) / setup_params.wavelength
...
# @jax.jit
# def multiple_layers_no_reflection(
#     setup_params: SetupParams,
#     optics_params: OpticsParams,
#     layer_params: LayerParams,
# ) -> Tuple[float, float, float]:
